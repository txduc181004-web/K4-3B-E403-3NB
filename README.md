...
**Lớp:** 3B · **Phòng:** E403 · **Cụm:** C5 · **Track:** A2

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
|2A202602768 |Trần Xuân Đức  |Nhóm trưởng |Backend/UI & tích hợp prototype |
|2A202602827 |Nguyễn Thành Nam |Thành viên |Data mining & phân tích chatlog |
|2A202602616 |Nguyễn Lê Phước Tiến |Thành viên |Thiết kế AI Agent & logic phát hiện lỗ hổng |
...
=======
>>>>>>> 92d3e24 (feat: complete Vlearn classgap map)
